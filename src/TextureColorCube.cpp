...
int main() {
  ...
  unsigned char *data = stbi_load((imagePath + "\\container2.png").c_str(),
                                  &width, &height, &channels, 0);
  if (!data) {
    std::cout << "Failed to load texture1 " << imagePath + "\\container2.png"
              << std::endl;
    return -1;
  }
  ...
  data = stbi_load((imagePath + "\\container2_specular.png").c_str(), &width,
                   &height, &channels, 0);
  if (!data) {
    std::cout << "Failed to load texture1 "
              << imagePath + "\\container2_specular.png" << std::endl;
    return -1;
  }
  GLuint specularMap;
  ...
  // ------------------------------------
  Shader litObjectShader("textureColorCube.vs.glsl", "textureColorCube.fs.glsl",
                         shaderPath.c_str());
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    litObjectShader.setFloat("material.shininess", 64.0f);
