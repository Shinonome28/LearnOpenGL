...
namespace LearnOpenGLUtils
{
	...
	public:
		OpenGLExcption(const std::string &message, const std::string &log) : mMessage(message), mLog(log) {}
	...
	{
	public:
		ShaderCompilationException(const std::string &message, const std::string &log) : OpenGLExcption(message, log) {}
	};

	class ShaderLinkingException : public OpenGLExcption
	{
	public:
		ShaderLinkingException(const std::string &message, const std::string &log) : OpenGLExcption(message, log) {}
	};
} // namespace LearnOpenGLUtils